...
export default function PageHeader({ title, action }) {
  ...
  return (
    <div className="lg:hidden sticky top-0 z-10 bg-white dark:bg-gray-900 border-b-2 border-brand-500 px-4 py-3 flex items-center justify-between max-w-lg mx-auto">
      <button
        onClick={() => navigate(-1)}
