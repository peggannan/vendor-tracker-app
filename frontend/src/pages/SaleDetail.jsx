  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-32 max-w-lg mx-auto lg:max-w-full">
      ...
      <div className="px-4 pt-4 lg:px-8 lg:pt-6">
        ...
        {/* Page title + Add button — desktop only */}
        ...
        {topProduct && (
          <div
            ...
            className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm mb-4 flex items-center justify-between cursor-pointer border border-gray-100 dark:border-gray-700"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-bold text-gray-800 dark:text-gray-100 text-sm mt-0.5">
                  {topProduct.name}
                </p>
                <p className="text-xs text-gray-400">
                  {topProduct.units_sold ?? 0} units sold recently
                </p>
              </div>
            </div>
      ...
      {/* Add Item button — mobile only, fixed at bottom */}
